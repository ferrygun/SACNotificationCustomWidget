(function () {
    ...
    class NotificationListItemAps extends HTMLElement {
        constructor() {
            super();
        ...
        _submit(e) {
            e.preventDefault();
            let properties = {};
            for (let name of NotificationListItemAps.observedAttributes) {
    ...
    customElements.define("com-fd-djaja-sap-sac-notificationlistitem-aps", NotificationListItemAps);
})();